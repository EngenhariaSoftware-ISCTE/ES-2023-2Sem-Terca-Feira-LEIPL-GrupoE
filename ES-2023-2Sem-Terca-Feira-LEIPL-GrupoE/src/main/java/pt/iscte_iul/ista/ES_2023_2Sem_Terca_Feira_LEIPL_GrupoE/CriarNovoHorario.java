 ...
 *Classe responsável por implementar método de criação de novo horário
 *de acordo com escolha de ucs por parte de aluno
 */
...
public class CriarNovoHorario {
	 ...
	 * @return h - retorna um horário com as aulas das usc escolhidas pelo(a) aluno(a)
	 */
