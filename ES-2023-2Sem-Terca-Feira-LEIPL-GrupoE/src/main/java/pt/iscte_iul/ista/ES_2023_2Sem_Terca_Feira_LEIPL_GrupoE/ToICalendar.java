...
/**
 * Classe ToICalendar responsável por converter uma String em um objeto Calendar (ical4j).
 */
public class ToICalendar {
    /**
     * Converte uma String com dados no formato iCalendar em um objeto Calendar (ical4j).
     *
